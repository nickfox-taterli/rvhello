...
proc ensure_project {{use_sram 0}} {
    ...
    foreach path {src/core/rv32i_core.v src/core/prog_mem.v src/periph/bus_decode.v src/periph/gpio.v src/periph/uart_tx.v src/periph/timer.v src/periph/sram_async.v src/board/clk_pll.v src/board/top.v src/board/seg_display.v} {
